*---------------------------------------------------------------
.
. Program Name: ai_gem.pls
. Description:  PL/B AIOBJECT sample using Gemini
.
. Revision History:
.
. Date: 03/12/2026 WK
...
// Global data
mainForm        PLFORM          aiobj_gem.plf
chatDtMessages  DATATABLE
chatAI          AIOBJECT
Client          CLIENT

Instruct        INIT            "You are Gemini, an helpful assistant":
                ...
                %ENCRYPTON
apiKey          INIT            "Add your OpenAI API key here" // gemini
                %ENCRYPTOFF
...
result          FORM            5
                ...
                chatAI.Question Giving result Using Question

                IF              (result != 0 )
                ALERT           NOTE,"The question failed.",result
                ELSE
...
cleanData       DIM             64000
                ...
                aiRes.getstring Giving cleanData using "candidates[0].content.parts[0].text"
...
decryptedApiKey DIM             200
                ...
                chatAI.Initialize Using "gemini-2.5-flash",decryptedApiKey,Instruct
