...
. Date: 01-03-2001
.
. Sample CLIENT test to demonstrate use of the PROGID='Plbwin.ProgramNE'
. class.  This shows how immediate responses can be received when an
. EventSend program method is executed.
.
App             AUTOMATION
Prog1           AUTOMATION
.
...
.
                App.CreateProgramNE Giving Prog1 USING FALSE
.
                Prog1.Run       Using "NEsrv"
...
...
.
                ...
                ELSE
...
. There has been an error trying to start NESrv program.  Need to check
. and make sure that the NESrv program is accessible.
.
                INSERTITEM      DataList1,9999,"Unable to load NESrv Program!"
                INSERTITEM      DataList1,9999,S$CMDLIN
                ENDIF
                ENDIF
                RETURN
...
.
                TYPE            S$CMDLIN
                IF              NOT EOS
                INSERTITEM      DataList1,9999,"NESrv Error Detected!"
                INSERTITEM      DataList1,9999,S$CMDLIN
                ENDIF
                RETURN
